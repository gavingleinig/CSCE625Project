...
def render_point(viewpoint_camera, pc : GaussianModel, kernel_size, camera_center, world_view_transform, full_proj_transform, \
                 pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, require_coord : bool = True, require_depth : bool = True):
    """
    Render the scene. 
